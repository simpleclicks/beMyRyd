package com.sym.bemyryd.betherydr;
...
import com.sym.bemyryd.MapMyRyde;
...
public class BetherydrActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.betherydr_main);
		...
		button.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if(srcLocation==null || (srcLatLongRep=getLatLongFromAddress(srcLocation.toString()))==null){
					isAddressValid = false;
					atvPlaces_src.setBackgroundColor(Color.parseColor("#F75D59"));
				}
				if(dstLocation==null || (dstLatLongRep=getLatLongFromAddress(dstLocation.toString()))==null){
					isAddressValid = false;
					atvPlaces_dst.setBackgroundColor(Color.parseColor("#F75D59"));
				}
				if(isAddressValid==true){
					String jsonString = "{ " +
							"\"start\": " +
							"{\"lat\": "+srcLatLongRep.getLatitude()+","+
							"\"lon\": "+srcLatLongRep.getLongitude()+ "},"+
							"\"end\": " +
							"{\"lat\": "+dstLatLongRep.getLatitude()+","+
							"\"long\": "+dstLatLongRep.getLongitude()+ "}"+
							"}";
					Intent i = new Intent(cont, MapMyRyde.class);
					startActivity(i);
				}
	...
	private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String,String>>>{
		...
		protected void onPostExecute(List<HashMap<String, String>> result) {
			...
			//FilterWithSpaceAdapter<String> adapter = new FilterWithSpaceAdapter<String>(getBaseContext(),
		     //       android.R.layout.simple_dropdown_item_1,from);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.betherydr_main, menu);
		return true;
	}
}
